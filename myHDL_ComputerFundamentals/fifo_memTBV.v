...
always @(fifo_full, fifo_threshold, fifo_overflow, data_out, wr, fifo_underflow, fifo_empty, clk, data_in, rst_n, clear, rd) begin: FIFO_MEMTBV_PRINT_DATA
    $write("%h", wr);
    $write(" ");
    $write("%h", rd);
    $write(" ");
...
always @(fifo_mem0_0_rptr, fifo_mem0_0_fifoStatus0_0_1_2_fifo_empty_i, wr, rd, fifo_mem0_0_fifoStatus0_0_1_2_fifo_full_i, fifo_mem0_0_wptr) begin: FIFO_MEMTBV_FIFO_MEM0_0_FIFOSTATUS0_0_1_2_LOGIC1
...
always @(fifo_mem0_0_fifoStatus0_0_1_2_fbit_comp, fifo_mem0_0_fifoStatus0_0_1_2_pointer_equal, fifo_mem0_0_fifoStatus0_0_1_2_pointer_result) begin: FIFO_MEMTBV_FIFO_MEM0_0_FIFOSTATUS0_0_1_2_LOGIC2
