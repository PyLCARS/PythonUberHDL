...
always @(fifo_full, fifo_threshold, fifo_overflow, rptr, wr, fifo_underflow, fifo_empty, fifo_rd, rd, fifo_we, wptr) begin: FIFOSTATUSTBV_PRINT_DATA
    $write("%h", wr);
    $write(" ");
    $write("%h", rd);
    $write(" ");
...
always @(rptr, fifoStatus0_0_fifo_empty_i, wr, rd, fifoStatus0_0_fifo_full_i, wptr) begin: FIFOSTATUSTBV_FIFOSTATUS0_0_LOGIC1
